...
public class EncryptionBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof EntityManagerFactory) {
            ...
            registry.appendListeners(EventType.FLUSH_ENTITY, encryptionListener);
            registry.appendListeners(EventType.FLUSH, encryptionListener);
            registry.appendListeners(EventType.AUTO_FLUSH, encryptionListener);
